...
| :--- | :--- | :--- |
| `invoices` | Accounting → **Invoice** | <https://docs.merge.dev/merge-unified/accounting/common-models/invoices/list> |
| `customers` | Accounting → **Contact** (entities classified as customers/suppliers) | <https://docs.merge.dev/merge-unified/accounting/common-models/contacts/list> |
| `contacts` | CRM → **Contact** (individual people) | <https://docs.merge.dev/merge-unified/crm/common-models/contacts/list> |
...
**Reference:** <https://docs.merge.dev/merge-unified/accounting/common-models/invoices/list>
...
**Reference:** <https://docs.merge.dev/merge-unified/accounting/common-models/contacts/list>
...
**Reference:** <https://docs.merge.dev/merge-unified/crm/common-models/contacts/list>
